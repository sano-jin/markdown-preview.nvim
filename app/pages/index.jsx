...
import { renderProofTrees } from "./prooftree.js";

// const renderPT = (_) => renderProofTrees({styleOnLoad: 100});
  ...
  onRefreshContent({
    ...
    if (!this.md) {
      ...
      this.md
        ...
        .use(renderProofTrees, {styleOnLoad: 100});
    }
    ...
    const refreshRender = () => {
      this.setState({
        ...
        if (refreshContent) {
          ...
          renderFlowchart()
          renderDot()
          renderProofTrees({styleOnLoad: 100})
        }
        refreshScroll()
      })
    }
    ...
    return (
      <React.Fragment>
        <Head>
          ...
          {/* <script type="text/javascript" src="/_static/prooftree.js"></script> */}
